...
import { ClearCartinf, createCheckoutSession, LoadCartinf, RemoveIteminf } from '../Utils/Utils';
                            ...
                            <div className="pointer-events-auto w-screen max-w-md">
                                <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                    ...
                                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                        ...
                                        <div className="mt-6">
                                            <button onClick={Checkout} className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Checkout</button>
                                            <button onClick={handleClearCart} className="mt-2 flex items-center justify-center rounded-md border border-transparent bg-red-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-red-700">Clear Cart</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
